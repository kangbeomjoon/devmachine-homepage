...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL ?? "https://devmachine-homepage.vercel.app"),
  ...
  icons: {
    icon: "/images/devmachine-operator-v6.png",
    shortcut: "/images/devmachine-operator-v6.png",
    apple: "/images/devmachine-operator-v6.png",
  },
  openGraph: {
    title: "데브머신 | 웹사이트와 업무 자동화 개발",
